...
# 80 --> AUTOMATION
# 9PM Light1 --> 1 --> Automation
# 9PM light1 --> 0 --> AUTOMATION
...
def isContradictingBehavior(i, df, automations):
    ...
    if contradictory_behavior in automations:
        ...
        """ @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        - COMPARE TIME OF AUTOMATION CREATION
        - IF IT is done within 0-7 days. IT IS NOT A AUTOMATION. UPDATE INITIAL CONFIDENCE
        - Alpha UPDATE
        """
